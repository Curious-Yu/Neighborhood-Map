...
class App extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            'alllocations': [
                {
                    'name': "StarBucks @ Village Parkway",
                    'type': "Coffee Shop",
                    'latitude': 37.703275,
                    'longitude': -121.9439948,
                    'streetAddress': "7197 Village Pkwy A, Dublin, CA 94568"
                },
                {
                  'name': "StarBucks @ Safeway",
                  'type': "Coffee Shop",
                    'latitude': 37.703275,
                    'longitude': -121.9439948,
                    'streetAddress': "7499 Dublin Blvd, Dublin, CA 94568"
                },
                {
                  'name': "StarBucks @ Amador Plaza",
                  'type': "Coffee Shop",
                    'latitude': 37.703275,
                    'longitude': -121.9439948,
                    'streetAddress': "7200 Amador Plaza Rd, Dublin, CA 94568"
                },
                {
                  'name': "StarBucks @ Stoneridge",
                  'type': "Coffee Shop",
                    'latitude': 37.703275,
                    'longitude': -121.9439948,
                    'streetAddress': "1140 Stoneridge Mall Rd B 119, Pleasanton, CA 94588"
                },
                {
                  'name': "StarBucks @ Johnson Drive",
                  'type': "Coffee Shop",
                    'latitude': 37.703275,
                    'longitude': -121.9439948,
                    'streetAddress': "6050 Johnson Dr, Pleasanton, CA 94588"
                },
                {
                  'name': "StarBucks @ Dublin Blvd",
                  'type': "Coffee Shop",
                    'latitude': 37.7024155,
                    'longitude': -121.9387063,
                    'streetAddress': "7904 Dublin Blvd, Dublin, CA 94568"
                }
            ],
            'map': '',
            'infowindow': '',
    ...
    componentDidMount() {
        ...
        loadMapJS('https://maps.googleapis.com/maps/api/js?key=AIzaSyDZGYUN5PN33ozVazGh6YMIRx-Ydt9tm6s&callback=initMap')
    }
    ...
    initMap() {
        ...
        var map = new window.google.maps.Map(mapview, {
            center: {lat: 37.703658, lng: -121.918662},
            zoom: 14,
